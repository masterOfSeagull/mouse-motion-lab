...
int main(int argc,char** argv){
    if(argc!=12){std::cerr<<"usage: mousegen_cli MODEL start_x start_y target_x target_y radius seed left top width height\n";return 2;}
