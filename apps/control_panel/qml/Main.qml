    ...
    RowLayout {
        ...
        Rectangle {
            ...
            ColumnLayout {
                ...
                Button { text: "Datasets"; onClicked: currentPage = 5; Layout.fillWidth: true }
        ...
        StackLayout {
            ...
            Item {
                id: datasetPage
                property var datasets: appController.datasetController
                ColumnLayout {
                    anchors.fill: parent
                    anchors.margins: 34
                    spacing: 12
                    RowLayout {
                        ...
                        Item { Layout.fillWidth: true }
                        Button { text: "Refresh"; onClicked: datasetPage.datasets.refresh() }
                    }
                    Label {
                    ...
                    RowLayout {
                        ...
                        Button { text: "Build snapshot"; onClicked: datasetPage.datasets.buildSnapshot(snapshotName.text) }
                    }
                    Label { text: datasetPage.datasets.message; color: "#4b5563"; wrapMode: Text.Wrap; Layout.fillWidth: true }
                    Rectangle {
                        Layout.fillWidth: true
                        Layout.fillHeight: true
                        color: "#ffffff"
                        border.color: "#d1d5db"
                        radius: 6
                        Label { anchors.centerIn: parent; visible: datasetPage.datasets.snapshots.length === 0; text: "No snapshots yet. Retained completed sessions with verified raw files are eligible."; color: "#6b7280"; width: parent.width - 30; wrapMode: Text.Wrap; horizontalAlignment: Text.AlignHCenter }
                        ListView {
                            anchors.fill: parent
                            anchors.margins: 12
                            clip: true
                            spacing: 6
                            model: datasetPage.datasets.snapshots
                            ScrollBar.vertical: ScrollBar { policy: ScrollBar.AsNeeded }
                            delegate: Rectangle {
                                required property var modelData
                                width: ListView.view.width
